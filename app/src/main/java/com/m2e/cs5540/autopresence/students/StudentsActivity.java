...
public class StudentsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        studentCoursesRecyclerView = (RecyclerView) findViewById(R.id
              .studentCourseRecyclerView);
        List<CourseEnrollment> courseEnrollmentList = DatabaseUtil
              .getInstance().getCourseEnrollmentsByUserId(savedInstanceState
                    .getString("userId"));
        studentCoursesAdapter = new StudentCoursesAdapter(courseEnrollmentList);
    }
