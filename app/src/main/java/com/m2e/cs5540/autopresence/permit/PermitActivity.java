...
public class PermitActivity extends AppCompatActivity
   ...
   @Override protected void onCreate(Bundle savedInstanceState) {
      ...
      semesterAdapter = ArrayAdapter.createFromResource(this, R.array.semester,
      ...
      try {
         courses = databaseUtil.getAllCourses();
      } catch (Exception e) {
         e.printStackTrace();
      }
   ...
   public Loader<AsyncLoaderStatus> onCreateLoader(int id, Bundle args) {
      ...
      Log.i(TAG, "$$$$$$ RegisterActivity.onCreateLoader called");
   ...
   @Override public void onLoadFinished(Loader<AsyncLoaderStatus> loader,
      ...
      Log.i(TAG, "$$$$$$ PermitActivity.onLoadFinished called");
   ...
   public void addPermit() {
      ...
      final ProgressDialog progressDialog = new ProgressDialog(
            PermitActivity.this, R.style.Theme_AppCompat_Light_DarkActionBar);
